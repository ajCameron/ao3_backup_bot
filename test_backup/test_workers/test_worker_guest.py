...
"""
Tests handling one id from the workers.
"""
...
from ao3_backup.workers.worker_guest import handle_one_guest
...
class TestHandleOneGuest:
    """
    Tests the handle one guest logic.
    """
    @staticmethod
    def test_create_blocks_and_enqueue(tmp_path, monkeypatch) -> Engine:
